...
![image-20260815001329883](imgs\image-20260815001329883.png)

然后在软件配置界面左侧列表中选择**RemoteID**。

![image-20260815001602222](D:\00-repository\Y-wingspan\nextpilot-website-docs\docs\product\07-无人机运行识别模块\imgs\image-20260815001602222.png)

#### 设置产品唯一标识

打开BasicID区域下Broadcast滑块按钮。填入一个20字符的产品唯一标识。

![image-20260815000919914](imgs\image-20260815000919914.png)

#### 设置实名认证

打开OperatorID区域下Broadcast滑块按钮。填入一个8字符的实名认证信息，即操作手身份证后8位。

![image-20260815001007073](imgs\image-20260815001007073.png)
...
![qgc_basic_id](imgs\qgc_basic_id.png)

#### 设置无人机分类

现有名称与GB46750规范内的名称对应关系如下图：

![qgc_basic_id_2](imgs\qgc_basic_id_2.png)

#### 设置操控站位置信息

建议选择Fixed，然后填入地面站经纬度、高度。

![image-20260815000204608](imgs\image-20260815000204608.png)

如果选择的不是Fixed，则RID自动使用飞控起飞点的位置。

#### 正常状态

![image-20260815001927712](imgs\image-20260815001927712.png)
...
> 这里以NP-RID-Sender-S3-GH板子为例，如果使用其他板子，请在[接口说明](#jiekoushuoming)章节找到对应板子的调试串口，与USB转TTL模块连接，然后再将USB转TTL模块插入计算机。
...
![image-20260814235035851](imgs\参数设置.png)
